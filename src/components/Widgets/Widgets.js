...
export default function Widgets({ followResults, trendingResults }) {
  return (
    <div className="hidden lg:inline ml-8 md:w-auto xl:w-[450px] py-1 space-y-5">
      ...
      <div className="text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 rounded-xl w-11/12 xl:w-9/12">
        ...
        {trendingResults.articles.map((result, index) => (
          <Link href={result?.url} key={index} target="_blank">
